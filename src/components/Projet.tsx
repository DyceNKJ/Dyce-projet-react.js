    ...
    <section id='projets' className='mb-9 overflow-x-hidden overflow-y-hidden'>
        ...
        <div className=' items-center justify-center mx-auto space-y-10 sm:flex-col md:flex lg:flex-row lg:space-x-16 lg:space-y-0'>
            ...
            <div className='md:max-w-2xl lg:max-w-4xl grid md:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-0 lg:gap-x-20 lg:space-y-7 md:space-y-6 items-center justify-center md:mx-12 md:gap-x-5 mx-auto lg:mx-0 lg:mr-14 '>
                ...
                {/* Card 1 */}
                <div className="from-left max-w-4xl bg-gray-900 rounded-lg shadow-lg p-4 w-75">
                    <img src={site} alt="" className="w-full rounded-lg" />
                    <h3 className="mt-2 font-bold text-white">Dyce PORTFOLIO</h3>
                    <p className="text-white text-sm whitespace-normal mt-2">Portfolio web développé avec Vue.js 3 & TypeScript avec filtrage, pagination, formulaire EmailJS (historique des contacts enregistré pour relances), effets de parallaxe, et backend Firebase (Firestore) avec interface admin sécurisée.</p>
                ...
                {/* Card 2 */}
                <div className="from-left max-w-4xl bg-gray-900 rounded-lg shadow-lg p-4 w-75 h-119">
...
Services : Formations, Communication, Études & Conseil, Conseil en Affaires, Création & Gestion d’Entreprise (accompagnement juridique, business plan, partenaires, systèmes d’information).</p>
                ...
                {/* Card 3 */}
                <div className="from-right max-w-4xl bg-gray-900 rounded-lg shadow-lg p-4 w-75 h-119">
                    <img src={first} alt="" className="w-full rounded-lg" />
                    <h3 className="mt-2 font-bold text-white">Dyce Portfolio - React Edition</h3>
                    <p className="text-white text-sm whitespace-normal mt-2">Portfolio expérimental développé avec React.js et Vite, conçu comme un terrain d’entraînement pour approfondir les fondamentaux fu framework React et explorer les bonnes pratiques modernes du front-end.</p>
                    ...
                    <div className="flex flex-wrap gap-2 text-left text-sm">
                        ...
                        <p className=" text-black bg-sky-700 text-center p-1 mt-2 gap-2 w-13 h-7 rounded-lg">Joy UI</p>
                ...
                {/* Card 4 */}
                <div className="from-right max-w-4xl bg-gray-900 rounded-lg shadow-lg p-4 w-75 md:h-119 lg:h-auto">
                    ...
                    <div className="flex flex-wrap gap-2 text-left text-sm mb-5">
                        ...
                        <div className="flex space-x-2 mt-4 md:mt-13 lg:mt-auto">
                            <button type='button' className='bg-sky-700 hover:bg-sky-800 p-3 mt-3 w-51 rounded-xl cursor-pointer'>
                ...
                {/* Card 5 */}
                <div className="from-down max-w-4xl bg-gray-900 rounded-lg shadow-lg p-4 w-75">
                ...
                {/* Card 6 */}
                <div className="from-down max-w-4xl bg-gray-900 rounded-lg shadow-lg p-4 w-75 mb-7">
                    <img src={resto} alt="" className="w-full h-35 rounded-lg" />
                    <h3 className="mt-2 font-bold text-white">Bistrot Élégant : L’Art Culinaire Réinventé</h3>
                    <p className="text-white text-sm whitespace-normal mt-2">Le Bistrot Élégant vous invite à vivre une expérience gastronomique unique, mêlant tradition et créativité, pour des instants gourmands dans une ambiance chaleureuse et raffinée.</p>
                    ...
                    <div className="flex flex-wrap gap-2 text-left text-sm">
                        ...
                        <div className="flex space-x-2 mt-3 disabled:cursor-not-allowed">
                        <Tooltip title="Pas encore disponible" arrow>
                        <button type='button' className='bg-sky-700 hover:bg-sky-800 p-3 mt-3 w-51 rounded-xl cursor-pointer'>
                            <a className="">Demo <i className="fa-regular fa-circle-play"></i></a>
                        </button>
                        </Tooltip>
                        <button type='button' className='bg-sky-600 hover:bg-sky-400 p-3 mt-3 w-30 rounded-xl cursor-pointer'>
                            <a href="https://github.com/DyceNKJ" className=""><i className="fab fa-github text-white"></i></a>
