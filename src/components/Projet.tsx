...
const Projet = () => {
  ...
  return (
    <section
      id="projets"
      className="bg-gray-900  overflow-x-hidden overflow-y-hidden"
    >
      {/* Projets */}
      <div className="max-w-7xl mx-auto">
        <h1 className="text-white text-center font-bold text-3xl my-16 mb-2">
          Mes Projets
        </h1>
        <p className="text-white text-center text-xl mb-8">
          Parcourez mes réalisations et mesurez l’impact concret de mes
          solutions.
        </p>
      </div>
        ...
        <div className="flex flex-col p-5 md:p-5 space-y-8">
          ...
          <div className="lg:flex md:flex-row space-x-5 group">
            <div className="from-left bg-gray-800 rounded-lg shadow-lg shadow-black/50 p-4 w-full md:w-100 lg:w-300 lg:h-90 h-60 hover:scale-105 group-hover:-translate-x-4 transition-transform duration-400 lg:ml-3 xl:ml-9">
              <img
                src={site}
                alt=""
                className="w-full h-full rounded-lg hover:scale-96 transition-transform duration-600"
              />
            </div>
            ...
            <div className="from-right flex flex-col group-hover:translate-x-4 lg:ml-3 transition-transform duration-1000">
              ...
              <div className="flex space-x-2 mt-4">
                <button
                  type="button"
                  className="bg-sky-700 hover:bg-sky-800 p-3 mt-3 w-51 rounded-xl cursor-pointer"
                >
                  <OpenInNewIcon />
                  <a
                    href="https://claudyce-corneille.vercel.app/"
                ...
                <button
                  type="button"
                  className="bg-sky-600 hover:bg-sky-400 p-3 mt-3 w-30 rounded-xl cursor-pointer"
                >
                  <a href="https://github.com/DyceNKJ" className="">
          ...
          <div className="lg:flex md:flex-row-reverse space-x-5 group">
            ...
            <div className="from-left xl:ml-9 flex flex-col group-hover:translate-x-5 lg:ml-3 transition-transform duration-700">
              ...
              <p className="text-white text-sm whitespace-normal mt-2 lg:w-4/5 xl:w-4/5">
                Site web développé pour CABICONS, cabinet conseils. Services :
                Formations, Communication, Études & Conseil, Conseil en
                Affaires, Création & Gestion d’Entreprise (accompagnement
                juridique, business plan, partenaires, systèmes d’information).
              </p>
              ...
              <div className="flex space-x-2 mt-5">
                ...
                >
                  <OpenInNewIcon />
                  <a
                    href="https://cabicons.vercel.app/"
                    className="font-bold ml-3"
                  >
                    Voir le projet
                  </a>
          ...
          <div className="lg:flex md:flex-row space-x-5 group">
            ...
            <div className="from-right flex flex-col group-hover:translate-x-4 lg:ml-3 transition-transform duration-1000">
              ...
              <p className="text-white text-sm whitespace-normal mt-2 lg:w-4/5 xl:w-4/5">
                Portfolio moderne et immersif conçu pour mettre en valeur mes
                compétences en développement front-end et en design
                d’interfaces.
              </p>
              ...
              <div className="flex space-x-2 mt-5">
                <button
                  type="button"
                  className="bg-sky-700 hover:bg-sky-800 p-3 mt-3 w-51 rounded-xl cursor-pointer hidden"
                >
                  <a href="" className="font-bold">
                    Demo <i className="fa-regular fa-circle-play"></i>
                  </a>
                </button>
                <button
                  type="button"
                  className="bg-sky-600 hover:bg-sky-400 p-3 mt-3 w-80 rounded-xl cursor-pointer"
                >
                  <a
                    href="https://github.com/DyceNKJ/Dyce-projet-react.js"
                    className=""
                  >
                    <GitHubIcon className="text-white" />
                  </a>
          ...
          <div className="lg:flex md:flex-row-reverse space-x-5 group">
            ...
            <div className="from-left xl:ml-9 flex flex-col group-hover:translate-x-5 lg:ml-3 transition-transform duration-700">
              ...
              <p className="text-white text-sm whitespace-normal mt-2 lg:w-4/5 xl:w-4/5">
                Découvrez un exemple complet de portfolio, mettant l’accent sur
                la maîtrise des fondamentaux du front-end, la structuration du
                code, la gestion des interactions et l’optimisation de
                l’interface.
              </p>
          ...
          <div className="lg:flex md:flex-row space-x-5 group">
            ...
            <div className="from-right flex flex-col group-hover:translate-x-4 lg:ml-3 transition-transform duration-1000">
              <div className="flex space-x-4">
                ...
                <div className="flex flex-col">
                  <h3 className="mt-2 font-bold text-white md:text-2xl">
                    Portfolio Créations Vidéo – AMV & Montages
                  </h3>
                  <p className="text-sky-600 font-bold">Chaîne YouTube</p>
                </div>
              </div>
              <p className="text-white text-sm whitespace-normal mt-2 lg:w-4/5 xl:w-4/5">
                Explorez mes AMV et montages vidéo publiés sur YouTube, avec un
                accent sur le rythme, les transitions, les effets visuels et
                l’impact émotionnel, afin de créer des vidéos dynamiques et
                captivantes.
              </p>
              ...
              <div className="flex space-x-2 mt-3">
                <button
                  type="button"
                  className="bg-sky-700 hover:bg-sky-800 p-3 mt-3 w-80 rounded-xl cursor-pointer"
                >
                  <a
                    href="https://www.youtube.com/@Dyce_Nekomonji/videos"
                    className="font-bold"
                  >
                    Demo <i className="fa-regular fa-circle-play"></i>
                  </a>
          ...
          <div className="lg:flex md:flex-row-reverse space-x-5 group">
            ...
            <div className="from-left xl:ml-9 flex flex-col group-hover:translate-x-5 lg:ml-3 transition-transform duration-700">
              <div className="flex space-x-4">
                ...
                <div className="flex flex-col">
                  <h3 className="mt-2 font-bold text-white md:text-2xl">
                    Le Bistrot Élégant, Restaurant virtuel
                  </h3>
                  <p className="text-sky-600 font-bold">App Web</p>
                </div>
              </div>
              <p className="text-white text-sm whitespace-normal mt-2 lg:w-4/5 xl:w-4/5">
                Bistrot Élégant est restaurant virtuel conçu pour démontrer la
                capacité à concevoir une expérience utilisateur cohérente,
                allant de la sélection des plats jusqu’à la réservation et
                pré-commande.
              </p>
              ...
              <div className="flex space-x-2 mt-1 md:mt-2 disabled:cursor-not-allowed">
                <Tooltip title="En cours de maintenance" arrow>
                  <button
                    type="button"
                    className="hidden bg-sky-700 hover:bg-sky-800 p-3 mt-3 w-51 rounded-xl cursor-not-allowed"
                  >
                    <OpenInNewIcon />
                    <a className="font-bold ml-3 cursor-not-allowed">
                      Voir le projet
                    </a>
                  </button>
                </Tooltip>
                ...
                >
                  <OpenInNewIcon />
                  <a
                    href="https://le-bistrot-elegant-sooty.vercel.app/"
                    className="font-bold ml-3"
                  >
                    Voir le projet{" "}
                  </a>
                ...
                <button
                  type="button"
                  className="bg-sky-600 hover:bg-sky-400 p-3 mt-3 w-30 rounded-xl cursor-not-allowed"
                >
